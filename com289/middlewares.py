...
class Com289SpiderMiddleware(object):
...
class Com289DownloaderMiddleware(object):
    # Not all methods need to be defined. If a method is not defined,
...
class JSPageMiddleware(object):
    def __init__(self):
        ...
        self.browser = webdriver.PhantomJS(executable_path='D:/phantomjs/bin/phantomjs.exe', desired_capabilities=dcap)
